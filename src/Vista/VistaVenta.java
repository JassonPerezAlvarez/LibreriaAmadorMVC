...
public class VistaVenta extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTextNombreVenta = new javax.swing.JTextField();
        jTextDescripcionVenta = new javax.swing.JTextField();
        ...
        jLabel2.setText("Descripcion Venta");
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jTextNombreVenta, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(35, 35, 35)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTextDescripcionVenta, javax.swing.GroupLayout.PREFERRED_SIZE, 127, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTextNombreVenta, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jTextDescripcionVenta, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jButtonGuardar))
                .addGap(32, 32, 32)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        ...
        for (int i = 0; i < model.getRowCount(); i++) {
            ...
            if (nombre.contains(textoBusqueda) || descripcion.contains(textoBusqueda)) {
                jTableVenta.setRowSelectionInterval(i, i);
                jTableVenta.scrollRectToVisible(jTableVenta.getCellRect(i, 0, true));
                encontrado = true;
                break;
            }
        }
        ...
        if (!encontrado) {
            JOptionPane.showMessageDialog(this, "No se encontró ninguna Venta con ese término.");
        }
    }//GEN-LAST:event_jButtonBuscarActionPerformed

    private void jButtonGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonGuardarActionPerformed
        // TODO add your handling code here:
            String nombre = jTextNombreVenta.getText().trim();
        String descripcion = jTextDescripcionVenta.getText().trim();
        ...
        jTextNombreVenta.setText("");
        jTextDescripcionVenta.setText("");
    ...
    private void jButtonActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonActualizarActionPerformed
        ...
        if (filaSeleccionada >= 0) {
            String nuevoNombre = jTextNombreVenta.getText().trim();
            String nuevaDescripcion = jTextDescripcionVenta.getText().trim();
    ...
    private javax.swing.JTextField jTextDescripcionVenta;
    private javax.swing.JTextField jTextNombreVenta;
