...
public class DAOCliente {
    ...
    public void crearCliente(Cliente cliente) throws SQLException {
        ...
        try (Connection c = ConexionDB.getConnection();
             CallableStatement cs = c.prepareCall("{CALL AgregarCliente(?, ?, ?, ?, ?, ?)}")) {
    ...
    public void actualizarCliente(Cliente cliente) throws SQLException {
        ...
        try (Connection c = ConexionDB.getConnection();
             CallableStatement cs = c.prepareCall("{CALL ActualizarCliente(?, ?, ?, ?, ?, ?, ?)}")) {
    ...
    public void eliminarCliente(int idCliente) throws SQLException {
        ...
        try {
            ...
            // Eliminar el cliente (las ventas y detalles se eliminan automáticamente por ON DELETE CASCADE)
            try (CallableStatement cs = conn.prepareCall("{CALL EliminarCliente(?)}")) {
